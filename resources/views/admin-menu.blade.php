<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo_xonacatzy.png') }}" class="block h-9 w-auto" alt="" width="10%">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('administrador.eliminar-datos') }}" :active="request()->routeIs('administrador.eliminar-datos')">
                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if (DB::table('users')->where('tipoUsuario', 'Administrador')->where('id', auth()->user()->id))
                            <x-dropdown-link href="{{ route('administrador.index') }}">
                                {{ 'Panel Administrador' }}
                            </x-dropdown-link>
                            @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('administrador.eliminar-datos') }}" :active="request()->routeIs('administrador.eliminar-datos')">
                {{ 'Eliminar Información' }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div>
                    <div class="font-medium text-base text-gray-800">{{ Auth::user()->nombre }} {{ Auth::user()->apPaterno }} {{ Auth::user()->apMaterno }}</div>
