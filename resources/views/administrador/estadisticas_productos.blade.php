        ...
        <div class="flex items-center">
            @foreach ($productos as $index => $producto)
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ 'Estadísticas de venta de ' }}{{ $producto->nombre }}&nbsp;&nbsp;
                </h2>
            @endforeach
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="flex w-full overflow-hidden bg-white rounded-lg shadow-md">
                        ...
                        <div class="px-4 py-2 -mx-3">
                            <div class="mx-3">
                                ...
                                <p class="text-sm text-gray-600">No puedo mostrar las estadísticas porque no hay ninguna venta registrada a este producto</p>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    // Obtén los IDs de los productos en un array de JavaScript
                    var id = @json($productos->pluck('id')->toArray());
                
                    // Agrega un evento click a los botones de la consulta1
                    consulta1.addEventListener('click', function () {
                        actualizarGrafico(`/administrador/estadistica/producto/meses/${id}`);
                    });
                    ...
                    consulta2.addEventListener('click', function () {
                        ...
                        actualizarGrafico(`/administrador/estadistica/producto/${id}/fecha1/${fechaInicio}/fecha2/${fechaFin}`);
                    });
